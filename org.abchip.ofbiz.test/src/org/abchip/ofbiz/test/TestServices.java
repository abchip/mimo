...
public class TestServices {
	...
	public static Map<String, Object> testFirstService(DispatchContext dctx, Map<String, Object> context) {

		Map<String, Object> resultMap = ServiceUtil.returnSuccess("You have called on service 'testFirstService' successfully!");
		return resultMap;
	}
	...
	public static Map<String, Object> callingServiceOne(DispatchContext dctx, Map<String, Object> context) {
		...
		Map<String, Object> resultMap = null;
		try {
			resultMap = dispatcher.runSync("testCallingServiceTwo", serviceTwoCtx);
			resultMap.put("fullName", firstName + " " + lastName);
		} catch (GenericServiceException e) {
			Debug.logError(e, TestServices.class.getName());
		}
