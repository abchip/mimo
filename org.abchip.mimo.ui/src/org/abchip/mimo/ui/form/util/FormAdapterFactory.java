...
public class FormAdapterFactory extends AdapterFactoryImpl {
	...
	protected FormSwitch<Adapter> modelSwitch =
		new FormSwitch<Adapter>() {
			...
			@Override
			public Adapter caseEntityIdentifiable(EntityIdentifiable object) {
				return createEntityIdentifiableAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.abchip.mimo.entity.EntityIdentifiable <em>Identifiable</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createEntityIdentifiableAdapter() {
		return null;
	}
