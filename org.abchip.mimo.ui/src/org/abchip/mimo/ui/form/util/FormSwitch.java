 ...
 */
package org.abchip.mimo.ui.form.util;
 ...
 * <!-- end-user-doc -->
 * @see org.abchip.mimo.ui.form.FormPackage
 * @generated
 */
public class FormSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FormPackage.FORM: {
				...
				if (result == null) result = caseEntityIdentifiable(form);
				if (result == null) result = caseEntity(form);
			...
			case FormPackage.FORM_FIELD: {
				...
				if (result == null) result = caseEntity(formField);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseEntityIdentifiable(EntityIdentifiable object) {
		return null;
	}
