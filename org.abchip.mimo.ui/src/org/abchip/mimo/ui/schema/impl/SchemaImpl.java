 ...
 * </p>
 * <ul>
 *   <li>{@link org.abchip.mimo.ui.schema.impl.SchemaImpl#getColumns <em>Columns</em>}</li>
 *   <li>{@link org.abchip.mimo.ui.schema.impl.SchemaImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SchemaImpl extends EntityIdentifiableImpl implements Schema {
	 ...
	 * @ordered
	 */
	protected EList<SchemaColumn> columns;
	 ...
	 */
	@Override
	public SchemaColumn getColumn(String id) {
		for (SchemaColumn column : this.getColumns()) {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SchemaPackage.SCHEMA__COLUMNS:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case SchemaPackage.SCHEMA__COLUMNS:
				getColumns().clear();
				getColumns().addAll((Collection<? extends SchemaColumn>)newValue);
				return;
			case SchemaPackage.SCHEMA__NAME:
