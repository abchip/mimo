 ...
 */
package org.abchip.mimo.ui.event.util;
 ...
 * <!-- end-user-doc -->
 * @see org.abchip.mimo.ui.event.EventPackage
 * @generated
 */
public class EventAdapterFactory extends AdapterFactoryImpl {
	...
	protected EventSwitch<Adapter> modelSwitch =
		new EventSwitch<Adapter>() {
			@Override
			public Adapter caseEventEntry(EventEntry object) {
				return createEventEntryAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.abchip.mimo.ui.event.EventEntry <em>Entry</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createEventEntryAdapter() {
		return null;
	}
