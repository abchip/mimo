...
public interface DatabaseQueryPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int NAME_HELPER_REGISTRY_FEATURE_COUNT = ContextPackage.REGISTRY_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int QUERY_WRITER_REGISTRY_FEATURE_COUNT = ContextPackage.REGISTRY_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int QUERY_PARSER_REGISTRY_FEATURE_COUNT = ContextPackage.REGISTRY_FEATURE_COUNT + 0;
