 ...
 * </p>
 * <ul>
 *   <li>{@link org.abchip.mimo.database.definition.impl.RollbackStatementImpl#isHold <em>Hold</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RollbackStatementImpl extends DefinitionStatementImpl implements RollbackStatement {
	...
	protected EClass eStaticClass() {
		return DatabaseDefinitionPackage.Literals.ROLLBACK_STATEMENT;
	}
	...
	public void setHold(boolean newHold) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatabaseDefinitionPackage.ROLLBACK_STATEMENT__HOLD, oldHold, hold));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DatabaseDefinitionPackage.ROLLBACK_STATEMENT__HOLD:
				return isHold();
		}
