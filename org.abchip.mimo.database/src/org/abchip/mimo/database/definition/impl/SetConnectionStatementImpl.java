...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Set Connection Statement</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.abchip.mimo.database.definition.impl.SetConnectionStatementImpl#getDatabaseName <em>Database Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SetConnectionStatementImpl extends DefinitionStatementImpl implements SetConnectionStatement {
	 ...
	 * @generated
	 */
	protected SetConnectionStatementImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return DatabaseDefinitionPackage.Literals.SET_CONNECTION_STATEMENT;
	}
	...
	public void setDatabaseName(String newDatabaseName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatabaseDefinitionPackage.SET_CONNECTION_STATEMENT__DATABASE_NAME, oldDatabaseName, databaseName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DatabaseDefinitionPackage.SET_CONNECTION_STATEMENT__DATABASE_NAME:
