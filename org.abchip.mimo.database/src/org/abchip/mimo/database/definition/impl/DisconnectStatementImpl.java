 ...
 * </p>
 * <ul>
 *   <li>{@link org.abchip.mimo.database.definition.impl.DisconnectStatementImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DisconnectStatementImpl extends DefinitionStatementImpl implements DisconnectStatement {
	...
	protected EClass eStaticClass() {
		return DatabaseDefinitionPackage.Literals.DISCONNECT_STATEMENT;
	}
	...
	public void setTarget(TargetItem newTarget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatabaseDefinitionPackage.DISCONNECT_STATEMENT__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DatabaseDefinitionPackage.DISCONNECT_STATEMENT__TARGET:
				return getTarget();
		}
