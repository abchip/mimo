 ...
 * </p>
 * <ul>
 *   <li>{@link org.abchip.mimo.database.definition.impl.DatabaseObjectDefImpl#getLabel <em>Label</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class DatabaseObjectDefImpl extends MinimalEObjectImpl.Container implements DatabaseObjectDef {
	...
	protected EClass eStaticClass() {
		return DatabaseDefinitionPackage.Literals.DATABASE_OBJECT_DEF;
	}
	...
	public void setLabel(String newLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatabaseDefinitionPackage.DATABASE_OBJECT_DEF__LABEL, oldLabel, label));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DatabaseDefinitionPackage.DATABASE_OBJECT_DEF__LABEL:
				return getLabel();
		}
