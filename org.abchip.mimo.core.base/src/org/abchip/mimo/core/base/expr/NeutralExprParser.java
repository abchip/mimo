...
public class NeutralExprParser extends Parser {
	...
	// C:\\MyPath\\NeutralExpr.g:75:1: expression : logicalExpression ( ( AS_ASS | AS_DIV | AS_MIN | AS_PLUS | AS_POW | AS_TIM | AS_GENERIC ) ^ logicalExpression )* EOF !;
	public final NeutralExprParser.expression_return expression() throws RecognitionException {
		...
		try {
			// C:\\MyPath\\NeutralExpr.g:76:2: ( logicalExpression ( ( AS_ASS | AS_DIV | AS_MIN | AS_PLUS | AS_POW | AS_TIM | AS_GENERIC ) ^ logicalExpression )* EOF !)
			// C:\\MyPath\\NeutralExpr.g:76:4: logicalExpression ( ( AS_ASS | AS_DIV | AS_MIN | AS_PLUS | AS_POW | AS_TIM | AS_GENERIC ) ^ logicalExpression )* EOF !
			{
			...
			// C:\\MyPath\\NeutralExpr.g:76:22: ( ( AS_ASS | AS_DIV | AS_MIN | AS_PLUS | AS_POW | AS_TIM | AS_GENERIC ) ^ logicalExpression )*
			loop1:
			while (true) {
				int alt1=2;
				...
				switch (alt1) {
				case 1 :
					// C:\\MyPath\\NeutralExpr.g:76:23: ( AS_ASS | AS_DIV | AS_MIN | AS_PLUS | AS_POW | AS_TIM | AS_GENERIC ) ^ logicalExpression
					{
					set2=input.LT(1);
					set2=input.LT(1);
	...
	// C:\\MyPath\\NeutralExpr.g:79:1: logicalExpression : booleanAndExpression ( LE_OR ^ booleanAndExpression )* ;
	public final NeutralExprParser.logicalExpression_return logicalExpression() throws RecognitionException {
		...
		try {
			// C:\\MyPath\\NeutralExpr.g:80:2: ( booleanAndExpression ( LE_OR ^ booleanAndExpression )* )
			// C:\\MyPath\\NeutralExpr.g:80:4: booleanAndExpression ( LE_OR ^ booleanAndExpression )*
			{
			root_0 = (CommonTree)adaptor.nil();
			...
			// C:\\MyPath\\NeutralExpr.g:80:25: ( LE_OR ^ booleanAndExpression )*
			loop2:
			while (true) {
				int alt2=2;
				...
				switch (alt2) {
				case 1 :
					// C:\\MyPath\\NeutralExpr.g:80:26: LE_OR ^ booleanAndExpression
					{
	...
	// C:\\MyPath\\NeutralExpr.g:83:1: booleanAndExpression : booleanGenExpression ( LE_AND ^ booleanGenExpression )* ;
	public final NeutralExprParser.booleanAndExpression_return booleanAndExpression() throws RecognitionException {
		...
		try {
			// C:\\MyPath\\NeutralExpr.g:84:2: ( booleanGenExpression ( LE_AND ^ booleanGenExpression )* )
			// C:\\MyPath\\NeutralExpr.g:84:4: booleanGenExpression ( LE_AND ^ booleanGenExpression )*
			{
			root_0 = (CommonTree)adaptor.nil();
			...
			// C:\\MyPath\\NeutralExpr.g:84:25: ( LE_AND ^ booleanGenExpression )*
			loop3:
			while (true) {
				int alt3=2;
				...
				switch (alt3) {
				case 1 :
					// C:\\MyPath\\NeutralExpr.g:84:26: LE_AND ^ booleanGenExpression
					{
	...
	// C:\\MyPath\\NeutralExpr.g:87:1: booleanGenExpression : equalityExpression ( LE_GENERIC ^ equalityExpression )* ;
	public final NeutralExprParser.booleanGenExpression_return booleanGenExpression() throws RecognitionException {
		...
		try {
			// C:\\MyPath\\NeutralExpr.g:88:2: ( equalityExpression ( LE_GENERIC ^ equalityExpression )* )
			// C:\\MyPath\\NeutralExpr.g:89:3: equalityExpression ( LE_GENERIC ^ equalityExpression )*
			{
			root_0 = (CommonTree)adaptor.nil();
			...
			// C:\\MyPath\\NeutralExpr.g:89:22: ( LE_GENERIC ^ equalityExpression )*
			loop4:
			while (true) {
				int alt4=2;
				...
				switch (alt4) {
				case 1 :
					// C:\\MyPath\\NeutralExpr.g:89:23: LE_GENERIC ^ equalityExpression
					{
	...
	// C:\\MyPath\\NeutralExpr.g:92:1: equalityExpression : relationalExpression ( ( RE_EQ | RE_NE ) ^ relationalExpression )* ;
	public final NeutralExprParser.equalityExpression_return equalityExpression() throws RecognitionException {
		...
		try {
			// C:\\MyPath\\NeutralExpr.g:93:2: ( relationalExpression ( ( RE_EQ | RE_NE ) ^ relationalExpression )* )
			// C:\\MyPath\\NeutralExpr.g:93:4: relationalExpression ( ( RE_EQ | RE_NE ) ^ relationalExpression )*
			{
			root_0 = (CommonTree)adaptor.nil();
			...
			// C:\\MyPath\\NeutralExpr.g:93:25: ( ( RE_EQ | RE_NE ) ^ relationalExpression )*
			loop5:
			while (true) {
				int alt5=2;
				...
				switch (alt5) {
				case 1 :
					// C:\\MyPath\\NeutralExpr.g:93:26: ( RE_EQ | RE_NE ) ^ relationalExpression
					{
					set15=input.LT(1);
					set15=input.LT(1);
	...
	// C:\\MyPath\\NeutralExpr.g:96:1: relationalExpression : additiveExpression ( ( RE_LT | RE_LTEQ | RE_GT | RE_GTEQ | RE_GENERIC ) ^ additiveExpression )* ;
	public final NeutralExprParser.relationalExpression_return relationalExpression() throws RecognitionException {
		...
		try {
			// C:\\MyPath\\NeutralExpr.g:97:2: ( additiveExpression ( ( RE_LT | RE_LTEQ | RE_GT | RE_GTEQ | RE_GENERIC ) ^ additiveExpression )* )
			// C:\\MyPath\\NeutralExpr.g:97:4: additiveExpression ( ( RE_LT | RE_LTEQ | RE_GT | RE_GTEQ | RE_GENERIC ) ^ additiveExpression )*
			{
			root_0 = (CommonTree)adaptor.nil();
			...
			// C:\\MyPath\\NeutralExpr.g:97:23: ( ( RE_LT | RE_LTEQ | RE_GT | RE_GTEQ | RE_GENERIC ) ^ additiveExpression )*
			loop6:
			while (true) {
				int alt6=2;
				...
				switch (alt6) {
				case 1 :
					// C:\\MyPath\\NeutralExpr.g:97:25: ( RE_LT | RE_LTEQ | RE_GT | RE_GTEQ | RE_GENERIC ) ^ additiveExpression
					{
					set18=input.LT(1);
					set18=input.LT(1);
	...
	// C:\\MyPath\\NeutralExpr.g:101:1: additiveExpression : multiplicativeExpression ( ( AE_PLUS | AE_MINUS ) ^ multiplicativeExpression )* ;
	public final NeutralExprParser.additiveExpression_return additiveExpression() throws RecognitionException {
		...
		try {
			// C:\\MyPath\\NeutralExpr.g:102:2: ( multiplicativeExpression ( ( AE_PLUS | AE_MINUS ) ^ multiplicativeExpression )* )
			// C:\\MyPath\\NeutralExpr.g:102:4: multiplicativeExpression ( ( AE_PLUS | AE_MINUS ) ^ multiplicativeExpression )*
			{
			root_0 = (CommonTree)adaptor.nil();
			...
			// C:\\MyPath\\NeutralExpr.g:102:29: ( ( AE_PLUS | AE_MINUS ) ^ multiplicativeExpression )*
			loop7:
			while (true) {
				int alt7=2;
				...
				switch (alt7) {
				case 1 :
					// C:\\MyPath\\NeutralExpr.g:102:31: ( AE_PLUS | AE_MINUS ) ^ multiplicativeExpression
					{
					set21=input.LT(1);
					set21=input.LT(1);
	...
	// C:\\MyPath\\NeutralExpr.g:105:1: multiplicativeExpression : unaryExpression ( ( AE_MULT | AE_DIV | AE_MOD | AE_POW | AE_GENERIC ) ^ unaryExpression )* ;
	public final NeutralExprParser.multiplicativeExpression_return multiplicativeExpression() throws RecognitionException {
		...
		try {
			// C:\\MyPath\\NeutralExpr.g:106:2: ( unaryExpression ( ( AE_MULT | AE_DIV | AE_MOD | AE_POW | AE_GENERIC ) ^ unaryExpression )* )
			// C:\\MyPath\\NeutralExpr.g:107:3: unaryExpression ( ( AE_MULT | AE_DIV | AE_MOD | AE_POW | AE_GENERIC ) ^ unaryExpression )*
			{
			root_0 = (CommonTree)adaptor.nil();
			...
			// C:\\MyPath\\NeutralExpr.g:107:19: ( ( AE_MULT | AE_DIV | AE_MOD | AE_POW | AE_GENERIC ) ^ unaryExpression )*
			loop8:
			while (true) {
				int alt8=2;
				...
				switch (alt8) {
				case 1 :
					// C:\\MyPath\\NeutralExpr.g:107:21: ( AE_MULT | AE_DIV | AE_MOD | AE_POW | AE_GENERIC ) ^ unaryExpression
					{
					set24=input.LT(1);
					set24=input.LT(1);
	...
	// C:\\MyPath\\NeutralExpr.g:110:1: unaryExpression : ( primaryExpression | LE_NOT primaryExpression | AE_SMINUS ^ primaryExpression | AE_SPLUS ^ primaryExpression );
	public final NeutralExprParser.unaryExpression_return unaryExpression() throws RecognitionException {
		...
		try {
			// C:\\MyPath\\NeutralExpr.g:111:2: ( primaryExpression | LE_NOT primaryExpression | AE_SMINUS ^ primaryExpression | AE_SPLUS ^ primaryExpression )
			int alt9=4;
			switch ( input.LA(1) ) {
			case AT_BOOL:
			case AT_DATE:
			...
			switch (alt9) {
				case 1 :
					// C:\\MyPath\\NeutralExpr.g:112:4: primaryExpression
					{
					root_0 = (CommonTree)adaptor.nil();
					...
					break;
				case 2 :
					// C:\\MyPath\\NeutralExpr.g:113:4: LE_NOT primaryExpression
					{
					root_0 = (CommonTree)adaptor.nil();
					...
					break;
				case 3 :
					// C:\\MyPath\\NeutralExpr.g:114:8: AE_SMINUS ^ primaryExpression
					{
					root_0 = (CommonTree)adaptor.nil();
					...
					break;
				case 4 :
					// C:\\MyPath\\NeutralExpr.g:115:8: AE_SPLUS ^ primaryExpression
					{
					root_0 = (CommonTree)adaptor.nil();
	...
	// C:\\MyPath\\NeutralExpr.g:119:1: primaryExpression : ( block | atomic );
	public final NeutralExprParser.primaryExpression_return primaryExpression() throws RecognitionException {
		...
		try {
			// C:\\MyPath\\NeutralExpr.g:120:2: ( block | atomic )
			int alt10=2;
			...
			switch (alt10) {
				case 1 :
					// C:\\MyPath\\NeutralExpr.g:120:4: block
					{
					root_0 = (CommonTree)adaptor.nil();
					...
					break;
				case 2 :
					// C:\\MyPath\\NeutralExpr.g:122:3: atomic
					{
					root_0 = (CommonTree)adaptor.nil();
	...
	// $ANTLR start "block"
	// C:\\MyPath\\NeutralExpr.g:125:1: block : BLOCK_OPEN ( logicalExpression )+ CLOSE_SQUARE -> ^( BE ( logicalExpression )+ ) ;
	public final NeutralExprParser.block_return block() throws RecognitionException {
		...
		try {
			// C:\\MyPath\\NeutralExpr.g:126:2: ( BLOCK_OPEN ( logicalExpression )+ CLOSE_SQUARE -> ^( BE ( logicalExpression )+ ) )
			// C:\\MyPath\\NeutralExpr.g:126:4: BLOCK_OPEN ( logicalExpression )+ CLOSE_SQUARE
			{
			...
			// C:\\MyPath\\NeutralExpr.g:126:15: ( logicalExpression )+
			int cnt11=0;
			loop11:
			while (true) {
				int alt11=2;
			...
			{
				// C:\\MyPath\\NeutralExpr.g:126:50: ^( BE ( logicalExpression )+ )
				{
	...
	// $ANTLR start "atomic"
	// C:\\MyPath\\NeutralExpr.g:129:1: atomic : ( AT_BOOL | AT_DATE | AT_FLOAT | AT_HEX | AT_INDICATOR | AT_INT | AT_NAME | AT_STRING | AT_GENERIC | QT | special | function );
	public final NeutralExprParser.atomic_return atomic() throws RecognitionException {
		...
		try {
			// C:\\MyPath\\NeutralExpr.g:130:2: ( AT_BOOL | AT_DATE | AT_FLOAT | AT_HEX | AT_INDICATOR | AT_INT | AT_NAME | AT_STRING | AT_GENERIC | QT | special | function )
			int alt12=12;
			switch ( input.LA(1) ) {
			case AT_BOOL:
				{
			...
			switch (alt12) {
				case 1 :
					// C:\\MyPath\\NeutralExpr.g:131:3: AT_BOOL
					{
					root_0 = (CommonTree)adaptor.nil();
					...
					break;
				case 2 :
					// C:\\MyPath\\NeutralExpr.g:132:4: AT_DATE
					{
					root_0 = (CommonTree)adaptor.nil();
					...
					break;
				case 3 :
					// C:\\MyPath\\NeutralExpr.g:133:5: AT_FLOAT
					{
					root_0 = (CommonTree)adaptor.nil();
					...
					break;
				case 4 :
					// C:\\MyPath\\NeutralExpr.g:134:4: AT_HEX
					{
					root_0 = (CommonTree)adaptor.nil();
					...
					break;
				case 5 :
					// C:\\MyPath\\NeutralExpr.g:135:4: AT_INDICATOR
					{
					root_0 = (CommonTree)adaptor.nil();
					...
					break;
				case 6 :
					// C:\\MyPath\\NeutralExpr.g:136:4: AT_INT
					{
					root_0 = (CommonTree)adaptor.nil();
					...
					break;
				case 7 :
					// C:\\MyPath\\NeutralExpr.g:137:4: AT_NAME
					{
					root_0 = (CommonTree)adaptor.nil();
					...
					break;
				case 8 :
					// C:\\MyPath\\NeutralExpr.g:138:4: AT_STRING
					{
					root_0 = (CommonTree)adaptor.nil();
					...
					break;
				case 9 :
					// C:\\MyPath\\NeutralExpr.g:139:4: AT_GENERIC
					{
					root_0 = (CommonTree)adaptor.nil();
					...
					break;
				case 10 :
					// C:\\MyPath\\NeutralExpr.g:140:4: QT
					{
					root_0 = (CommonTree)adaptor.nil();
					...
					break;
				case 11 :
					// C:\\MyPath\\NeutralExpr.g:141:5: special
					{
					root_0 = (CommonTree)adaptor.nil();
					...
					break;
				case 12 :
					// C:\\MyPath\\NeutralExpr.g:142:4: function
					{
					root_0 = (CommonTree)adaptor.nil();
	...
	// $ANTLR start "special"
	// C:\\MyPath\\NeutralExpr.g:145:1: special : SPECIAL_START s= SPECIAL CLOSE_BRACE CLOSE_BRACE -> AT_SPECIAL[$s.text] ;
	public final NeutralExprParser.special_return special() throws RecognitionException {
		...
		try {
			// C:\\MyPath\\NeutralExpr.g:146:2: ( SPECIAL_START s= SPECIAL CLOSE_BRACE CLOSE_BRACE -> AT_SPECIAL[$s.text] )
			// C:\\MyPath\\NeutralExpr.g:146:4: SPECIAL_START s= SPECIAL CLOSE_BRACE CLOSE_BRACE
			{
	...
	// C:\\MyPath\\NeutralExpr.g:149:1: function : FUN_START n= function_name CLOSE_BRACE OPEN_SQUARE ( params )* CLOSE_SQUARE -> ^( FT[$n.text] ( params )* ) ;
	public final NeutralExprParser.function_return function() throws RecognitionException {
		...
		try {
			// C:\\MyPath\\NeutralExpr.g:150:2: ( FUN_START n= function_name CLOSE_BRACE OPEN_SQUARE ( params )* CLOSE_SQUARE -> ^( FT[$n.text] ( params )* ) )
			// C:\\MyPath\\NeutralExpr.g:150:5: FUN_START n= function_name CLOSE_BRACE OPEN_SQUARE ( params )* CLOSE_SQUARE
			{
			...
			// C:\\MyPath\\NeutralExpr.g:150:55: ( params )*
			loop13:
			while (true) {
				int alt13=2;
	...
	// C:\\MyPath\\NeutralExpr.g:153:1: function_name : ( BI_FUN | TERM | INDICATOR | ALL | GENERIC );
	public final NeutralExprParser.function_name_return function_name() throws RecognitionException {
		...
		try {
			// C:\\MyPath\\NeutralExpr.g:154:2: ( BI_FUN | TERM | INDICATOR | ALL | GENERIC )
	...
	// $ANTLR start "params"
	// C:\\MyPath\\NeutralExpr.g:167:1: params : logicalExpression ( logicalExpression )* ;
	public final NeutralExprParser.params_return params() throws RecognitionException {
		...
		try {
			// C:\\MyPath\\NeutralExpr.g:168:2: ( logicalExpression ( logicalExpression )* )
			// C:\\MyPath\\NeutralExpr.g:169:3: logicalExpression ( logicalExpression )*
			{
			root_0 = (CommonTree)adaptor.nil();
			...
			// C:\\MyPath\\NeutralExpr.g:169:21: ( logicalExpression )*
			loop14:
			while (true) {
				int alt14=2;
				switch ( input.LA(1) ) {
				...
				switch (alt14) {
				case 1 :
					// C:\\MyPath\\NeutralExpr.g:169:22: logicalExpression
					{
