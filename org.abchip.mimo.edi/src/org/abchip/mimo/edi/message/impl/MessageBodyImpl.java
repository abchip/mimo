 ...
 * </p>
 * <ul>
 *   <li>{@link org.abchip.mimo.edi.message.impl.MessageBodyImpl#getContents <em>Contents</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MessageBodyImpl extends EntityImpl implements MessageBody {
	...
	public List<EntityIdentifiable> getContents() {
		if (contents == null) {
			contents = new EObjectContainmentEList.Resolving<EntityIdentifiable>(EntityIdentifiable.class, this, MessagePackage.MESSAGE_BODY__CONTENTS);
		}
		return contents;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MessagePackage.MESSAGE_BODY__CONTENTS:
