...
public class ExpressionPackageImpl extends EPackageImpl implements ExpressionPackage {
	 ...
	 * @generated
	 */
	private EClass functionTermExpressionEClass = null;
	 ...
	 * @generated
	 */
	private EClass qualifiedTermExpressionEClass = null;
	 ...
	 * @see org.abchip.mimo.expression.ExpressionPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EClass getFunctionTermExpression() {
		return functionTermExpressionEClass;
	}
	 ...
	 */
	@Override
	public EClass getQualifiedTermExpression() {
		return qualifiedTermExpressionEClass;
	}
	...
	public void createPackageContents() {
		...
		qualifiedTermExpressionEClass = createEClass(QUALIFIED_TERM_EXPRESSION);
	...
	public void initializePackageContents() {
		...
		qualifiedTermExpressionEClass.getESuperTypes().add(this.getCompoundTermExpression());
		...
		initEReference(getArithmeticExpression_LeftOperand(), this.getExpression(), null, "leftOperand", null, 1, 1, ArithmeticExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getArithmeticExpression_RightOperand(), this.getExpression(), null, "rightOperand", null, 1, 1, ArithmeticExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getArrayExpression_Expression(), this.getExpression(), null, "expression", null, 1, -1, ArrayExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getAssignmentExpression_LeftOperand(), this.getTermExpression(), null, "leftOperand", null, 1, 1, AssignmentExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getAssignmentExpression_RightOperand(), this.getExpression(), null, "rightOperand", null, 1, 1, AssignmentExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(atomicTermExpressionEClass, AtomicTermExpression.class, "AtomicTermExpression", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAtomicTermExpression_Type(), this.getAtomicType(), "type", null, 1, 1, AtomicTermExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(booleanExpressionEClass, BooleanExpression.class, "BooleanExpression", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getBooleanExpression_Operand(), this.getExpression(), null, "operand", null, 1, 1, BooleanExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getBlockExpression_Expression(), this.getExpression(), null, "expression", null, 1, 1, BlockExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(compoundTermExpressionEClass, CompoundTermExpression.class, "CompoundTermExpression", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCompoundTermExpression_Elements(), this.getExpression(), null, "elements", null, 0, -1, CompoundTermExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(expressionParserEClass, ExpressionParser.class, "ExpressionParser", IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEClass(expressionWriterRegistryEClass, ExpressionWriterRegistry.class, "ExpressionWriterRegistry", IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(expressionVisitorEClass, ExpressionVisitor.class, "ExpressionVisitor", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		op = addEOperation(expressionVisitorEClass, null, "endVisit", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getFunctionTermExpression(), "expression", 1, 1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(expressionVisitorEClass, null, "endVisit", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getQualifiedTermExpression(), "expression", 1, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEClass(functionTermExpressionEClass, FunctionTermExpression.class, "FunctionTermExpression", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEReference(getLogicalExpression_LeftOperand(), this.getExpression(), null, "leftOperand", null, 1, 1, LogicalExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getLogicalExpression_RightOperand(), this.getExpression(), null, "rightOperand", null, 0, 1, LogicalExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(qualifiedTermExpressionEClass, QualifiedTermExpression.class, "QualifiedTermExpression", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(relationalExpressionEClass, RelationalExpression.class, "RelationalExpression", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRelationalExpression_LeftOperand(), this.getExpression(), null, "leftOperand", null, 1, 1, RelationalExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRelationalExpression_RightOperand(), this.getExpression(), null, "rightOperand", null, 1, 1, RelationalExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(termExpressionEClass, TermExpression.class, "TermExpression", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTermExpression_Value(), ecorePackage.getEString(), "value", null, 0, 1, TermExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
