 ...
 * them. <!-- end-user-doc -->
 * @see org.abchip.mimo.expression.ExpressionPackage#getRelationalOperator()
 * @model
 * @generated
 */
public enum RelationalOperator implements Enumerator {
	 ...
	 * -->
	 * <p>
	 * If the meaning of '<em><b>Less Than Equal</b></em>' literal object isn't
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>Greater Than Equal</b></em>' literal object
	 ...
	 * @generated
	 */
	private static final RelationalOperator[] VALUES_ARRAY = new RelationalOperator[] {
			EQUAL,
			NOT_EQUAL,
			LESS_THAN,
			LESS_THAN_EQUAL,
