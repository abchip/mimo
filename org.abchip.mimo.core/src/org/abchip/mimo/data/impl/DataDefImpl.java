 ...
 * </p>
 * <ul>
 *   <li>{@link org.abchip.mimo.data.impl.DataDefImpl#getFormulas <em>Formulas</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class DataDefImpl<D> extends EntityImpl implements DataDef<D> {
	...
	public List<String> getFormulas() {
		if (formulas == null) {
			formulas = new EDataTypeUniqueEList<String>(String.class, this, DataPackage.DATA_DEF__FORMULAS);
		}
		return formulas;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataPackage.DATA_DEF__FORMULAS:
				return getFormulas();
		}
