 ...
 * </p>
 * <ul>
 *   <li>{@link org.abchip.mimo.data.impl.FloatingDefImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FloatingDefImpl extends DataDefImpl<Float> implements FloatingDef {
	...
	protected EClass eStaticClass() {
		return DataPackage.Literals.FLOATING_DEF;
	}
	...
	public void setType(FloatingType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.FLOATING_DEF__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataPackage.FLOATING_DEF__TYPE:
				return getType();
		}
