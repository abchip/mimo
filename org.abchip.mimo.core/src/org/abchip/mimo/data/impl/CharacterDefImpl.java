 ...
 * </p>
 * <ul>
 *   <li>{@link org.abchip.mimo.data.impl.CharacterDefImpl#getLength <em>Length</em>}</li>
 *   <li>{@link org.abchip.mimo.data.impl.CharacterDefImpl#isVarying <em>Varying</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CharacterDefImpl extends DataDefImpl<String> implements CharacterDef {
	...
	protected EClass eStaticClass() {
		return DataPackage.Literals.CHARACTER_DEF;
	}
	...
	public void setLength(int newLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.CHARACTER_DEF__LENGTH, oldLength, length));
	}
	...
	public void setVarying(boolean newVarying) {
		...
		varying = newVarying;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.CHARACTER_DEF__VARYING, oldVarying, varying));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataPackage.CHARACTER_DEF__LENGTH:
				return getLength();
			case DataPackage.CHARACTER_DEF__VARYING:
				return isVarying();
		}
