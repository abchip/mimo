...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Floating Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.abchip.mimo.util.UtilPackage#getFloatingType()
 * @model
 * @generated
 */
public enum FloatingType implements Enumerator {
	...
	/**
	 * A public read-only list of all the '<em><b>Floating Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * Returns the '<em><b>Floating Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public static FloatingType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			FloatingType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Floating Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	...
	/**
	 * Returns the '<em><b>Floating Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
