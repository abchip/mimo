...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Mapping Rule By Frame</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.abchip.mimo.resource.impl.ResourceMappingRuleByFrameImpl#getFrame <em>Frame</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResourceMappingRuleByFrameImpl extends ResourceMappingRuleImpl implements ResourceMappingRuleByFrame {
	 ...
	 * @generated
	 */
	protected ResourceMappingRuleByFrameImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ResourcePackage.Literals.RESOURCE_MAPPING_RULE_BY_FRAME;
	}
	...
	public void setFrame(String newFrame) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcePackage.RESOURCE_MAPPING_RULE_BY_FRAME__FRAME, oldFrame, frame));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ResourcePackage.RESOURCE_MAPPING_RULE_BY_FRAME__FRAME:
				return getFrame();
		}
