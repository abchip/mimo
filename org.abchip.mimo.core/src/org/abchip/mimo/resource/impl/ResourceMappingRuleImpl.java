...
public abstract class ResourceMappingRuleImpl extends EntityImpl implements ResourceMappingRule {
	 ...
	 * @generated
	 */
	protected ResourceMappingRuleImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ResourcePackage.Literals.RESOURCE_MAPPING_RULE;
	}
	...
	public void setProvider(String newProvider) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ResourcePackage.RESOURCE_MAPPING_RULE__PROVIDER, oldProvider, provider));
	}
