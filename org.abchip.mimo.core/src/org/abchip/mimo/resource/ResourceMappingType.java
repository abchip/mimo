 ...
 * <!-- end-user-doc -->
 * @see org.abchip.mimo.resource.ResourcePackage#getResourceMappingType()
 * @model
 * @generated
 */
public enum ResourceMappingType implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	private static final ResourceMappingType[] VALUES_ARRAY =
	 ...
	 * @generated
	 */
	public static final List<ResourceMappingType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	public static ResourceMappingType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ResourceMappingType result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static ResourceMappingType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ResourceMappingType result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static ResourceMappingType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ResourceMappingType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
