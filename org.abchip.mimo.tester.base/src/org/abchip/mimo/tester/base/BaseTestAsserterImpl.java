...
public class BaseTestAsserterImpl implements TestAsserter {

	private TestResult testResult;
	private long time;

	public BaseTestAsserterImpl(TestResult testResult) {
	...
	public void success(String message) {
		...
		// Create fail assertion
		AssertionSuccess assertionSuccess = TesterFactory.eINSTANCE.createAssertionSuccess();
