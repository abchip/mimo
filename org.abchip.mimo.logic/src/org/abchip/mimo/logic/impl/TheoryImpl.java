 ...
 * </p>
 * <ul>
 *   <li>{@link org.abchip.mimo.logic.impl.TheoryImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.abchip.mimo.logic.impl.TheoryImpl#getFacts <em>Facts</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TheoryImpl extends MinimalEObjectImpl.Container implements Theory {
	...
	protected EClass eStaticClass() {
		return LogicPackage.Literals.THEORY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LogicPackage.THEORY__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LogicPackage.THEORY__FACTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LogicPackage.THEORY__NAME:
				return getName();
			case LogicPackage.THEORY__FACTS:
				return getFacts();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case LogicPackage.THEORY__FACTS:
				getFacts().clear();
				getFacts().addAll((Collection<? extends Term>)newValue);
				return;
		}
