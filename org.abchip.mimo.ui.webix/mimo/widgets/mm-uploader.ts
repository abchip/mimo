...
export interface UploaderEntry extends EntryFramed {
}

export interface UploaderConfig extends WidgetConfig<UploaderEntry>, webix.ui.layoutConfig {
	upload: string;
}

export class WidgetUploader extends Widget<UploaderEntry, UploaderConfig, webix.ui.layout> {
	...
	public init(entry: UploaderEntry): void {

		var entities_upl1 = this.getUploader();
	...
	public ready(entry: UploaderEntry): void {
	...
	private getUploader(): webix.ui.uploader {
		return this.getView().queryView("entities_upl1") as webix.ui.uploader;
	}
