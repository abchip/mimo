...
public class SpeakerIdentificationDemo {
	...
	public static void printSpeakerIntervals(ArrayList<SpeakerCluster> speakers, String fileName) {
		...
		for (SpeakerCluster spk : speakers) {
			...
			for (Segment seg : segments)
				System.out.println(fileName + " " + " " + time(seg.getStartTime()) + " " + time(seg.getLength()) + " Speaker" + idx);
		}
	}
	 ...
	 *            intervals for decoding with per-speaker adaptation with
	 *            diarization.
	 * @param url
	 *            Url for the audio
	 * @throws Exception
	 ...
	 */
	public static void speakerAdaptiveDecoding(ArrayList<SpeakerCluster> speakers, URL url) throws Exception {
