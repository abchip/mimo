...
import org.abchip.mimo.database.impl.CatalogContainerImpl;
...
public class BaseCatalogContainerImpl extends CatalogContainerImpl {
	...
	protected void initialize() throws SQLException {
		...
		ConnectionCredentials credentials = getConnectionConfig().getCredentials();
			...
			try {
				...
				if (connectionConfig.isPersistent()) {
					...
					if (iConnectionProfile == null) {
						...
						String text = "MIMO Catalog " + connectionConfig.getVendor() + "(" + connectionConfig.getVersion() + ")";
