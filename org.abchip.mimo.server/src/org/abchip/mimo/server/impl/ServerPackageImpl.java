...
public class ServerPackageImpl extends EPackageImpl implements ServerPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getJob_DateFormat(), theDataPackage.getDateFormat(), "dateFormat", null, 0, 1, Job.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getJob_JobThread(), theContextPackage.getThread(), null, "jobThread", null, 0, 1, Job.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEOperation(jobEClass, null, "dispose", 0, 1, IS_UNIQUE, IS_ORDERED);
