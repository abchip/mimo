...
public interface SequencePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int SEQUENCE_VALUE_ITEM___ISA = BizPackage.BIZ_ENTITY___ISA;
	 ...
	 * @ordered
	 */
	int SEQUENCE_VALUE_ITEM___GET_NAME = BizPackage.BIZ_ENTITY___GET_NAME;
	 ...
	 * @ordered
	 */
	int SEQUENCE_VALUE_ITEM___GET_URI = BizPackage.BIZ_ENTITY___GET_URI;
	 ...
	 * @ordered
	 */
	int SEQUENCE_VALUE_ITEM___IS_PROXY = BizPackage.BIZ_ENTITY___IS_PROXY;
	 ...
	 * @ordered
	 */
	int SEQUENCE_VALUE_ITEM_OPERATION_COUNT = BizPackage.BIZ_ENTITY_OPERATION_COUNT + 0;
