...
public interface SemaphorePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int SERVICE_SEMAPHORE___ISA = BizPackage.BIZ_ENTITY___ISA;
	 ...
	 * @ordered
	 */
	int SERVICE_SEMAPHORE___GET_NAME = BizPackage.BIZ_ENTITY___GET_NAME;
	 ...
	 * @ordered
	 */
	int SERVICE_SEMAPHORE___GET_URI = BizPackage.BIZ_ENTITY___GET_URI;
	 ...
	 * @ordered
	 */
	int SERVICE_SEMAPHORE___IS_PROXY = BizPackage.BIZ_ENTITY___IS_PROXY;

	/**
	 * The number of operations of the '<em>Service Semaphore</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int SERVICE_SEMAPHORE_OPERATION_COUNT = BizPackage.BIZ_ENTITY_OPERATION_COUNT + 0;
