...
public class ShipmentGatewayConfigTypeImpl extends BizEntityTypeImpl<ShipmentGatewayConfig> implements ShipmentGatewayConfigType {
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Shipment_Package.SHIPMENT_GATEWAY_CONFIG_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public void setHasTable(boolean newHasTable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Shipment_Package.SHIPMENT_GATEWAY_CONFIG_TYPE__HAS_TABLE, oldHasTable, hasTable));
	}
	...
	public ShipmentGatewayConfigType getParentTypeId() {
		if (parentTypeId != null && ((EObject)parentTypeId).eIsProxy()) {
			...
			if (parentTypeId != oldParentTypeId) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Shipment_Package.SHIPMENT_GATEWAY_CONFIG_TYPE__PARENT_TYPE_ID, oldParentTypeId, parentTypeId));
			}
		}
		return parentTypeId;
	}
	...
	public void setParentTypeId(ShipmentGatewayConfigType newParentTypeId) {
		ShipmentGatewayConfigType oldParentTypeId = parentTypeId;
		parentTypeId = newParentTypeId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Shipment_Package.SHIPMENT_GATEWAY_CONFIG_TYPE__PARENT_TYPE_ID, oldParentTypeId, parentTypeId));
	}
	...
	public void setShipmentGatewayConfTypeId(String newShipmentGatewayConfTypeId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Shipment_Package.SHIPMENT_GATEWAY_CONFIG_TYPE__SHIPMENT_GATEWAY_CONF_TYPE_ID, oldShipmentGatewayConfTypeId, shipmentGatewayConfTypeId));
	}
