...
public class AgreementItemAttributeImpl extends BizEntityImpl implements AgreementItemAttribute {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AgreementPackage.AGREEMENT_ITEM_ATTRIBUTE__AGREEMENT_ID:
				return getAgreementId();
			case AgreementPackage.AGREEMENT_ITEM_ATTRIBUTE__AGREEMENT_ITEM_SEQ_ID:
				return getAgreementItemSeqId();
			case AgreementPackage.AGREEMENT_ITEM_ATTRIBUTE__ATTR_NAME:
				return getAttrName();
			case AgreementPackage.AGREEMENT_ITEM_ATTRIBUTE__ATTR_DESCRIPTION:
				return getAttrDescription();
			case AgreementPackage.AGREEMENT_ITEM_ATTRIBUTE__ATTR_VALUE:
				return getAttrValue();
		}
