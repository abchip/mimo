...
public interface AgreementContentType extends BizEntityType<AgreementContent> {
	 ...
	 * @model annotation="mimo-ent-domain frame='AgreementContentType'"
	 * @generated
	 */
	String getParentTypeId();

	/**
	 * Sets the value of the '{@link org.abchip.mimo.biz.party.agreement.AgreementContentType#getParentTypeId <em>Parent Type Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
