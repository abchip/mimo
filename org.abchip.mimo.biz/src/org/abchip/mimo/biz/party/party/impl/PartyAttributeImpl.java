...
public class PartyAttributeImpl extends BizEntityImpl implements PartyAttribute {
	...
	public void setAttrDescription(String newAttrDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PartyPackage.PARTY_ATTRIBUTE__ATTR_DESCRIPTION, oldAttrDescription, attrDescription));
	}
	...
	public void setAttrValue(String newAttrValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PartyPackage.PARTY_ATTRIBUTE__ATTR_VALUE, oldAttrValue, attrValue));
	}
	...
	public Party getPartyId() {
		if (partyId != null && ((EObject)partyId).eIsProxy()) {
			...
			if (partyId != oldPartyId) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PartyPackage.PARTY_ATTRIBUTE__PARTY_ID, oldPartyId, partyId));
			}
		}
		return partyId;
	}
	...
	public void setPartyId(Party newPartyId) {
		...
		partyId = newPartyId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PartyPackage.PARTY_ATTRIBUTE__PARTY_ID, oldPartyId, partyId));
	}
	...
	public void setAttrName(String newAttrName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PartyPackage.PARTY_ATTRIBUTE__ATTR_NAME, oldAttrName, attrName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PartyPackage.PARTY_ATTRIBUTE__ATTR_NAME:
				return getAttrName();
			case PartyPackage.PARTY_ATTRIBUTE__ATTR_DESCRIPTION:
				return getAttrDescription();
			case PartyPackage.PARTY_ATTRIBUTE__ATTR_VALUE:
				return getAttrValue();
			case PartyPackage.PARTY_ATTRIBUTE__PARTY_ID:
