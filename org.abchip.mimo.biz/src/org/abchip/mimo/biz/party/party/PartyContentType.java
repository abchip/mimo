...
public interface PartyContentType extends BizEntityType<PartyContent> {
	 ...
	 * @model annotation="mimo-ent-domain frame='PartyContentType'"
	 * @generated
	 */
	String getParentTypeId();

	/**
	 * Sets the value of the '{@link org.abchip.mimo.biz.party.party.PartyContentType#getParentTypeId <em>Parent Type Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
