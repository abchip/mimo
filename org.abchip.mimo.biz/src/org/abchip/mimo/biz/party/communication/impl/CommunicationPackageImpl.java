...
public class CommunicationPackageImpl extends EPackageImpl implements CommunicationPackage {
	...
	public void initializePackageContents() {
		...
		addEOperation(communicationEventEClass, theOrderPackage.getCommunicationEventOrder(), "communicationEventOrders", 0, -1, IS_UNIQUE, IS_ORDERED);

		addEOperation(communicationEventEClass, this.getCommunicationEventProduct(), "communicationEventProducts", 0, -1, IS_UNIQUE, IS_ORDERED);

		addEOperation(communicationEventEClass, this.getCommunicationEventPurpose(), "communicationEventPurposes", 0, -1, IS_UNIQUE, IS_ORDERED);

		addEOperation(communicationEventEClass, theReturnPackage.getCommunicationEventReturn(), "communicationEventReturns", 0, -1, IS_UNIQUE, IS_ORDERED);

		addEOperation(communicationEventEClass, theWorkeffortPackage.getCommunicationEventWorkEff(), "communicationEventWorkEffs", 0, -1, IS_UNIQUE, IS_ORDERED);

		addEOperation(communicationEventEClass, theRequestPackage.getCustRequestCommEvent(), "custRequestCommEvents", 0, -1, IS_UNIQUE, IS_ORDERED);

		addEOperation(communicationEventEClass, theSubscriptionPackage.getSubscriptionCommEvent(), "subscriptionCommEvents", 0, -1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(communicationEventPrpTypEClass, this.getCommunicationEventPrpTyp(), "childCommunicationEventPrpTyps", 0, -1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getCommunicationEventRole_PartyId(), thePartyPackage.getParty(), null, "partyId", null, 1, 1, CommunicationEventRole.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getCommunicationEventRole_PartyId().getEKeys().add(thePartyPackage.getParty_PartyId());
		initEReference(getCommunicationEventRole_RoleTypeId(), thePartyPackage.getRoleType(), null, "roleTypeId", null, 1, 1, CommunicationEventRole.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEOperation(communicationEventTypeEClass, this.getCommunicationEventType(), "childCommunicationEventTypes", 0, -1, IS_UNIQUE, IS_ORDERED);

		addEOperation(communicationEventTypeEClass, this.getCommunicationEvent(), "communicationEvents", 0, -1, IS_UNIQUE, IS_ORDERED);
	...
	protected void createMimoentformatAnnotations() {
		...
		addAnnotation
		  (getCommEventContentAssoc_ThruDate(),
		   source,
		   new String[] {
			   "type", "date-time"
		   });
		...
		addAnnotation
		  (getCommunicationEvent_BccString(),
		   source,
		   new String[] {
			   "type", "very-long"
		   });
		addAnnotation
		  (getCommunicationEvent_CcString(),
		   source,
		   new String[] {
			   "type", "very-long"
		   });
		addAnnotation
		  (getCommunicationEvent_Content(),
		   source,
		   new String[] {
			   "type", "very-long"
		   });
		addAnnotation
		  (getCommunicationEvent_DatetimeEnded(),
		   source,
		   new String[] {
			   "type", "date-time"
		   });
		addAnnotation
		  (getCommunicationEvent_DatetimeStarted(),
		   source,
		   new String[] {
			   "type", "date-time"
		   });
		addAnnotation
		  (getCommunicationEvent_EntryDate(),
		   source,
		   new String[] {
			   "type", "date-time"
		   });
		addAnnotation
		  (getCommunicationEvent_FromString(),
		   source,
		   new String[] {
			   "type", "very-long"
		   });
		addAnnotation
		  (getCommunicationEvent_HeaderString(),
		   source,
		   new String[] {
			   "type", "very-long"
		   });
		...
		addAnnotation
		  (getCommunicationEvent_ToString(),
		   source,
		   new String[] {
			   "type", "very-long"
		   });
		...
		addAnnotation
		  (getCommunicationEventPrpTyp_HasTable(),
		   source,
		   new String[] {
			   "type", "indicator",
			   "length", "1"
		...
		addAnnotation
		  (getCommunicationEventType_HasTable(),
		   source,
		   new String[] {
			   "type", "indicator",
			   "length", "1"
