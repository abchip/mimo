...
public interface KeywordPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int KEYWORD_THESAURUS___ISA = BizPackage.BIZ_ENTITY___ISA;
	 ...
	 * @ordered
	 */
	int KEYWORD_THESAURUS___GET_NAME = BizPackage.BIZ_ENTITY___GET_NAME;
	 ...
	 * @ordered
	 */
	int KEYWORD_THESAURUS___GET_URI = BizPackage.BIZ_ENTITY___GET_URI;
	 ...
	 * @ordered
	 */
	int KEYWORD_THESAURUS___IS_PROXY = BizPackage.BIZ_ENTITY___IS_PROXY;

	/**
	 * The number of operations of the '<em>Thesaurus</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int KEYWORD_THESAURUS_OPERATION_COUNT = BizPackage.BIZ_ENTITY_OPERATION_COUNT + 0;
