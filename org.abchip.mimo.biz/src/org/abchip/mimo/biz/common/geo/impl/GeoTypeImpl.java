...
public class GeoTypeImpl extends BizEntityTypeImpl<Geo> implements GeoType {
	 ...
	 * @ordered
	 */
	protected GeoType parentTypeId;
	...
	public GeoType getParentTypeId() {
		if (parentTypeId != null && ((EObject)parentTypeId).eIsProxy()) {
			...
			parentTypeId = (GeoType)eResolveProxy(oldParentTypeId);
			if (parentTypeId != oldParentTypeId) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GeoPackage.GEO_TYPE__PARENT_TYPE_ID, oldParentTypeId, parentTypeId));
			}
		}
		return parentTypeId;
	}
	 ...
	 * @generated
	 */
	public GeoType basicGetParentTypeId() {
		return parentTypeId;
	}
	...
	public void setParentTypeId(GeoType newParentTypeId) {
		GeoType oldParentTypeId = parentTypeId;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case GeoPackage.GEO_TYPE__HAS_TABLE:
				...
				return;
			case GeoPackage.GEO_TYPE__PARENT_TYPE_ID:
				setParentTypeId((GeoType)newValue);
				return;
		}
