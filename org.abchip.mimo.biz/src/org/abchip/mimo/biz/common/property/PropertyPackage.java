...
public interface PropertyPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int SYSTEM_PROPERTY__SYSTEM_RESOURCE_ID = BizPackage.BIZ_ENTITY_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int SYSTEM_PROPERTY__SYSTEM_PROPERTY_ID = BizPackage.BIZ_ENTITY_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int SYSTEM_PROPERTY___ISA = BizPackage.BIZ_ENTITY___ISA;
	 ...
	 * @ordered
	 */
	int SYSTEM_PROPERTY___GET_NAME = BizPackage.BIZ_ENTITY___GET_NAME;
	 ...
	 * @ordered
	 */
	int SYSTEM_PROPERTY___GET_URI = BizPackage.BIZ_ENTITY___GET_URI;
	 ...
	 * @ordered
	 */
	int SYSTEM_PROPERTY___IS_PROXY = BizPackage.BIZ_ENTITY___IS_PROXY;
	 ...
	 * @ordered
	 */
	int SYSTEM_PROPERTY_OPERATION_COUNT = BizPackage.BIZ_ENTITY_OPERATION_COUNT + 0;
