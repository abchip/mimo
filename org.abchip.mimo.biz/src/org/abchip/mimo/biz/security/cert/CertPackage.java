...
public interface CertPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int X509_ISSUER_PROVISION___ISA = BizPackage.BIZ_ENTITY___ISA;
	 ...
	 * @ordered
	 */
	int X509_ISSUER_PROVISION___GET_NAME = BizPackage.BIZ_ENTITY___GET_NAME;
	 ...
	 * @ordered
	 */
	int X509_ISSUER_PROVISION___GET_URI = BizPackage.BIZ_ENTITY___GET_URI;
	 ...
	 * @ordered
	 */
	int X509_ISSUER_PROVISION___IS_PROXY = BizPackage.BIZ_ENTITY___IS_PROXY;

	/**
	 * The number of operations of the '<em>X509 Issuer Provision</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int X509_ISSUER_PROVISION_OPERATION_COUNT = BizPackage.BIZ_ENTITY_OPERATION_COUNT + 0;
