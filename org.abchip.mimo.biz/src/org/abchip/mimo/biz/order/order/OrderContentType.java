...
public interface OrderContentType extends BizEntityType<OrderContent> {
	 ...
	 * @model annotation="mimo-ent-domain frame='OrderContentType'"
	 * @generated
	 */
	String getParentTypeId();

	/**
	 * Sets the value of the '{@link org.abchip.mimo.biz.order.order.OrderContentType#getParentTypeId <em>Parent Type Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
