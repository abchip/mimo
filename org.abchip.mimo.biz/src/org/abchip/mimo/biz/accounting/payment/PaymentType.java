...
public interface PaymentType extends BizEntityType<Payment> {
	...
	/**
	 * Sets the value of the '{@link org.abchip.mimo.biz.accounting.payment.PaymentType#getParentTypeId <em>Parent Type Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the value of the '<em><b>Payment Gl Account Type Maps</b></em>' attribute list.
	 ...
	 * @generated
	 */
	List<String> getPaymentGlAccountTypeMaps();

	/**
	 * Returns the value of the '<em><b>Payment Type Attrs</b></em>' attribute list.
	 * The list contents are of type {@link java.lang.String}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @generated
	 */
	List<String> getPaymentTypeAttrs();
