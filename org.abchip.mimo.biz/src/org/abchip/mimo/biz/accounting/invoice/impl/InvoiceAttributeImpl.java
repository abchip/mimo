...
public class InvoiceAttributeImpl extends BizEntityImpl implements InvoiceAttribute {
	...
	public void setAttrDescription(String newAttrDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InvoicePackage.INVOICE_ATTRIBUTE__ATTR_DESCRIPTION, oldAttrDescription, attrDescription));
	}
	...
	public void setAttrValue(String newAttrValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InvoicePackage.INVOICE_ATTRIBUTE__ATTR_VALUE, oldAttrValue, attrValue));
	}
	...
	public Invoice getInvoiceId() {
		if (invoiceId != null && ((EObject)invoiceId).eIsProxy()) {
			...
			if (invoiceId != oldInvoiceId) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InvoicePackage.INVOICE_ATTRIBUTE__INVOICE_ID, oldInvoiceId, invoiceId));
			}
		}
		return invoiceId;
	}
	...
	public void setInvoiceId(Invoice newInvoiceId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InvoicePackage.INVOICE_ATTRIBUTE__INVOICE_ID, oldInvoiceId, invoiceId));
	}
	...
	public void setAttrName(String newAttrName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InvoicePackage.INVOICE_ATTRIBUTE__ATTR_NAME, oldAttrName, attrName));
	}
