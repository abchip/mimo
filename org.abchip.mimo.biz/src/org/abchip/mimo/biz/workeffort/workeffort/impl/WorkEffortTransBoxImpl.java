...
public class WorkEffortTransBoxImpl extends BizEntityImpl implements WorkEffortTransBox {
	...
	/**
	 * The default value of the '{@link #getProcessWorkEffortId() <em>Process Work Effort Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected static final String PROCESS_WORK_EFFORT_ID_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getProcessWorkEffortId() <em>Process Work Effort Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getProcessWorkEffortId()
	 * @generated
	 * @ordered
	 */
	protected String processWorkEffortId = PROCESS_WORK_EFFORT_ID_EDEFAULT;
	 ...
	 */
	@Override
	public void setProcessWorkEffortId(String newProcessWorkEffortId) {
		String oldProcessWorkEffortId = processWorkEffortId;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case WorkeffortPackage.WORK_EFFORT_TRANS_BOX__PROCESS_WORK_EFFORT_ID:
				setProcessWorkEffortId((String)newValue);
				return;
			case WorkeffortPackage.WORK_EFFORT_TRANS_BOX__TO_ACTIVITY_ID:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case WorkeffortPackage.WORK_EFFORT_TRANS_BOX__PROCESS_WORK_EFFORT_ID:
				setProcessWorkEffortId(PROCESS_WORK_EFFORT_ID_EDEFAULT);
				return;
			case WorkeffortPackage.WORK_EFFORT_TRANS_BOX__TO_ACTIVITY_ID:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case WorkeffortPackage.WORK_EFFORT_TRANS_BOX__PROCESS_WORK_EFFORT_ID:
				return PROCESS_WORK_EFFORT_ID_EDEFAULT == null ? processWorkEffortId != null : !PROCESS_WORK_EFFORT_ID_EDEFAULT.equals(processWorkEffortId);
			case WorkeffortPackage.WORK_EFFORT_TRANS_BOX__TO_ACTIVITY_ID:
	...
	public String toString() {
		...
		result.append(" (processWorkEffortId: ");
		result.append(processWorkEffortId);
