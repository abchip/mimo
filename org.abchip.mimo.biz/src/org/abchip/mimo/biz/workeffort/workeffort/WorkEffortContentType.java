...
public interface WorkEffortContentType extends BizEntityType<WorkEffortContent> {
	 ...
	 * @model annotation="mimo-ent-domain frame='WorkEffortContentType'"
	 * @generated
	 */
	String getParentTypeId();

	/**
	 * Sets the value of the '{@link org.abchip.mimo.biz.workeffort.workeffort.WorkEffortContentType#getParentTypeId <em>Parent Type Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
