...
public interface WorkEffortAssocType extends BizEntityType<WorkEffortAssoc> {
	 ...
	 * @model annotation="mimo-ent-domain frame='WorkEffortAssocType'"
	 * @generated
	 */
	String getParentTypeId();

	/**
	 * Sets the value of the '{@link org.abchip.mimo.biz.workeffort.workeffort.WorkEffortAssocType#getParentTypeId <em>Parent Type Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the value of the '<em><b>Work Effort Assoc Type Attrs</b></em>' attribute list.
	 ...
	 * @generated
	 */
	List<String> getWorkEffortAssocTypeAttrs();
	 ...
	 * @generated
	 */
	List<String> childWorkEffortAssocTypes();
