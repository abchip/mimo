...
public class InventoryItemAttributeImpl extends BizEntityImpl implements InventoryItemAttribute {
	...
	public void setAttrDescription(String newAttrDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InventoryPackage.INVENTORY_ITEM_ATTRIBUTE__ATTR_DESCRIPTION, oldAttrDescription, attrDescription));
	}
	...
	public void setAttrValue(String newAttrValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InventoryPackage.INVENTORY_ITEM_ATTRIBUTE__ATTR_VALUE, oldAttrValue, attrValue));
	}
	...
	public InventoryItem getInventoryItemId() {
		if (inventoryItemId != null && ((EObject)inventoryItemId).eIsProxy()) {
			...
			if (inventoryItemId != oldInventoryItemId) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InventoryPackage.INVENTORY_ITEM_ATTRIBUTE__INVENTORY_ITEM_ID, oldInventoryItemId, inventoryItemId));
			}
		}
	...
	public void setInventoryItemId(InventoryItem newInventoryItemId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InventoryPackage.INVENTORY_ITEM_ATTRIBUTE__INVENTORY_ITEM_ID, oldInventoryItemId, inventoryItemId));
	}
	...
	public void setAttrName(String newAttrName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InventoryPackage.INVENTORY_ITEM_ATTRIBUTE__ATTR_NAME, oldAttrName, attrName));
	}
