...
public interface MrpPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int MRP_EVENT__MRP_ID = BizPackage.BIZ_ENTITY_TYPED_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int MRP_EVENT__EVENT_DATE = BizPackage.BIZ_ENTITY_TYPED_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int MRP_EVENT__EVENT_NAME = BizPackage.BIZ_ENTITY_TYPED_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int MRP_EVENT__IS_LATE = BizPackage.BIZ_ENTITY_TYPED_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int MRP_EVENT__QUANTITY = BizPackage.BIZ_ENTITY_TYPED_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int MRP_EVENT__PRODUCT_ID = BizPackage.BIZ_ENTITY_TYPED_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int MRP_EVENT__MRP_EVENT_TYPE_ID = BizPackage.BIZ_ENTITY_TYPED_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int MRP_EVENT__FACILITY_ID = BizPackage.BIZ_ENTITY_TYPED_FEATURE_COUNT + 7;
	 ...
	 * @ordered
	 */
	int MRP_EVENT___ISA = BizPackage.BIZ_ENTITY_TYPED___ISA;
	 ...
	 * @ordered
	 */
	int MRP_EVENT___GET_NAME = BizPackage.BIZ_ENTITY_TYPED___GET_NAME;
	 ...
	 * @ordered
	 */
	int MRP_EVENT___GET_URI = BizPackage.BIZ_ENTITY_TYPED___GET_URI;
	 ...
	 * @ordered
	 */
	int MRP_EVENT___IS_PROXY = BizPackage.BIZ_ENTITY_TYPED___IS_PROXY;
	 ...
	 * @ordered
	 */
	int MRP_EVENT___GET_TYPE = BizPackage.BIZ_ENTITY_TYPED___GET_TYPE;
	 ...
	 * @ordered
	 */
	int MRP_EVENT_OPERATION_COUNT = BizPackage.BIZ_ENTITY_TYPED_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int MRP_EVENT_TYPE___ISA = BizPackage.BIZ_ENTITY_TYPE___ISA;
	 ...
	 * @ordered
	 */
	int MRP_EVENT_TYPE___GET_NAME = BizPackage.BIZ_ENTITY_TYPE___GET_NAME;
	 ...
	 * @ordered
	 */
	int MRP_EVENT_TYPE___GET_URI = BizPackage.BIZ_ENTITY_TYPE___GET_URI;
	 ...
	 * @ordered
	 */
	int MRP_EVENT_TYPE___IS_PROXY = BizPackage.BIZ_ENTITY_TYPE___IS_PROXY;
	 ...
	 * @ordered
	 */
	int MRP_EVENT_TYPE___GET_FRAME = BizPackage.BIZ_ENTITY_TYPE___GET_FRAME;
	 ...
	 * @ordered
	 */
	int MRP_EVENT_TYPE___GET_TYPE_ID = BizPackage.BIZ_ENTITY_TYPE___GET_TYPE_ID;
	 ...
	 * @ordered
	 */
	int MRP_EVENT_TYPE___HAS_TABLE = BizPackage.BIZ_ENTITY_TYPE___HAS_TABLE;
	 ...
	 * @ordered
	 */
	int MRP_EVENT_TYPE___GET_TEXT = BizPackage.BIZ_ENTITY_TYPE___GET_TEXT;
	 ...
	 * @ordered
	 */
	int MRP_EVENT_TYPE_OPERATION_COUNT = BizPackage.BIZ_ENTITY_TYPE_OPERATION_COUNT + 0;
