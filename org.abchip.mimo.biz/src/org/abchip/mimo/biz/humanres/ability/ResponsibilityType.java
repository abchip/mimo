...
public interface ResponsibilityType extends BizEntity {
	 ...
	 * @model annotation="mimo-ent-domain frame='ResponsibilityType'"
	 * @generated
	 */
	String getParentTypeId();

	/**
	 * Sets the value of the '{@link org.abchip.mimo.biz.humanres.ability.ResponsibilityType#getParentTypeId <em>Parent Type Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
