...
public class TrackingPackageImpl extends EPackageImpl implements TrackingPackage {
	...
	protected void createMimoentformatAnnotations() {
		...
		addAnnotation
		  (getTrackingCode_LastModifiedDate(),
		   source,
		   new String[] {
			   "type", "date-time"
		   });
		...
		addAnnotation
		  (getTrackingCodeOrder_HasExported(),
		   source,
		   new String[] {
			   "type", "indicator",
			   "length", "1"
		...
		addAnnotation
		  (getTrackingCodeOrder_IsBillable(),
		   source,
		   new String[] {
			   "type", "indicator",
			   "length", "1"
		...
		addAnnotation
		  (getTrackingCodeOrderReturn_HasExported(),
		   source,
		   new String[] {
			   "type", "indicator",
			   "length", "1"
		...
		addAnnotation
		  (getTrackingCodeOrderReturn_IsBillable(),
		   source,
		   new String[] {
			   "type", "indicator",
			   "length", "1"
